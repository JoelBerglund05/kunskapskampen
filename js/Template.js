  ...
  templateCreator() {
    ...
    for (let i = 0; i < allGames.games.length; i++) {
      if (allGames.games[i].id === gameId) {
        ...
        this.matchContainer.querySelector("#yourScore").textContent =
          allGames.games[i].user_points_1;
        this.matchContainer.querySelector("#yourName").textContent =
          allGames.games[i].user_name_1 + ":";
        this.matchContainer.querySelector("#opponentScore").textContent =
          allGames.games[i].user_points_2;
        this.matchContainer.querySelector("#opponentName").textContent =
